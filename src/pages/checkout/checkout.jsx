...
import "./checkout.css";
import { CartContext } from "../../components/contexts/cart-contex.jsx";
        ...
        <div className="col-3">
          <div className="checkout-box">
            ...
            <div className="checkout-button">
              {liberar ? 
                <button onClick={FinalizarPedido} className="btn btn-checkout">
                  Finalizar Pedido
                </button>
              : 
                <button onClick={FinalizarPedido} className="btn btn-checkout" disabled >
                  Finalizar Pedido
                </button>}
            </div>
          </div>
